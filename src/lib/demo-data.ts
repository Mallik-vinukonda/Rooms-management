...
export const DEMO_ROOMS: RoomWithOccupancy[] = [
  ...
  makeRoom(31, { room_type: 'non_ac', status: 'vacant', building: 'main_second', floor: 'second', map_position: { row: 1, col: 0, section: 'wing_b' } }),
  makeRoom(32, { room_type: 'ac', has_ac: true, ac_status: 'working', status: 'occupied', building: 'main_second', floor: 'second', cleaning_status: 'cleaning_required', map_position: { row: 2, col: 0, section: 'wing_b' } },
    [stay('g18', 'room-32', d2)]),
  makeRoom(33, { room_type: 'non_ac', is_accommodation: false, purpose: 'Classroom', capacity: 0, status: 'vacant', building: 'main_second', floor: 'second', map_position: { row: 3, col: 0, section: 'wing_b' } }),
  makeRoom(34, { room_type: 'ac', has_ac: true, ac_status: 'working', status: 'reserved', building: 'main_second', floor: 'second', notes: 'Reserved for group visit Aug 15', map_position: { row: 4, col: 0, section: 'wing_b' } }),
  makeRoom(35, { room_type: 'dormitory', has_ac: true, ac_status: 'working', capacity: 6, status: 'vacant', building: 'main_second', floor: 'second', map_position: { row: 5, col: 0, section: 'wing_b' } }),
  makeRoom(36, { room_type: 'non_ac', is_accommodation: false, purpose: 'Storage', capacity: 0, status: 'vacant', building: 'main_second', floor: 'second', map_position: { row: 6, col: 0, section: 'wing_b' } }),
  makeRoom(37, { room_type: 'non_ac', is_accommodation: false, purpose: 'Storage', capacity: 0, status: 'vacant', building: 'main_second', floor: 'second', map_position: { row: 7, col: 0, section: 'wing_b' } }),
  makeRoom(38, { room_type: 'non_ac', is_accommodation: false, purpose: 'Office', capacity: 0, status: 'vacant', building: 'main_second', floor: 'second', map_position: { row: 8, col: 0, section: 'wing_b' } }),
  makeRoom(39, { room_type: 'non_ac', is_accommodation: false, purpose: 'Staff Room', capacity: 0, status: 'vacant', building: 'main_second', floor: 'second', map_position: { row: 9, col: 0, section: 'wing_b' } }),
  ...
  // Upper Block (40–54)
  makeRoom(40, { room_type: 'ac', has_ac: true, ac_status: 'working', status: 'occupied', building: 'main_first', floor: 'first', map_position: { row: 0, col: 0, side: 'left', section: 'upper_block' } },
    [stay('g19', 'room-40', d2), stay('g20', 'room-40', d1)]),
  makeRoom(41, { room_type: 'ac', has_ac: true, ac_status: 'working', status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 0, col: 1, side: 'right', section: 'upper_block' } }),
  makeRoom(42, { room_type: 'non_ac', is_accommodation: false, purpose: 'Classroom', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 1, col: 0, side: 'left', section: 'upper_block' } }),
  makeRoom(43, { room_type: 'non_ac', is_accommodation: false, purpose: 'Meeting Hall', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 1, col: 1, side: 'right', section: 'upper_block' } }),
  makeRoom(44, { room_type: 'non_ac', is_accommodation: false, purpose: 'Meeting Hall', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 2, col: 0, side: 'left', section: 'upper_block' } }),
  makeRoom(45, { room_type: 'non_ac', capacity: 3, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 2, col: 1, side: 'right', section: 'upper_block' } }),
  makeRoom(46, { room_type: 'non_ac', is_accommodation: false, purpose: 'Classroom', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 3, col: 0, side: 'left', section: 'upper_block' } }),
  makeRoom(47, { room_type: 'non_ac', is_accommodation: false, purpose: 'Storage', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 3, col: 1, side: 'right', section: 'upper_block' } }),
  makeRoom(48, { room_type: 'non_ac', is_accommodation: false, purpose: 'Storage', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 4, col: 0, side: 'left', section: 'upper_block' } }),
  makeRoom(49, { room_type: 'non_ac', is_accommodation: false, purpose: 'Storage', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 4, col: 1, side: 'right', section: 'upper_block' } }),
  makeRoom(50, { room_type: 'ac', has_ac: true, ac_status: 'working', status: 'occupied', building: 'separate_block', floor: 'separate_block', map_position: { row: 5, col: 0, side: 'left', section: 'upper_block' } },
    [stay('g21', 'room-50', d3), stay('g22', 'room-50', d1)]),
  makeRoom(51, { room_type: 'non_ac', is_accommodation: false, purpose: 'Meeting Hall', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 5, col: 1, side: 'right', section: 'upper_block' } }),
  makeRoom(52, { room_type: 'non_ac', is_accommodation: false, purpose: 'Storage', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 6, col: 0, side: 'left', section: 'upper_block' } }),
  makeRoom(53, { room_type: 'non_ac', is_accommodation: false, purpose: 'Meeting Hall', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 6, col: 1, side: 'right', section: 'upper_block' } }),
  makeRoom(54, { room_type: 'non_ac', is_accommodation: false, purpose: 'Office', capacity: 0, status: 'vacant', building: 'separate_block', floor: 'separate_block', map_position: { row: 7, col: 0, side: 'left', section: 'upper_block' } }),
];
